...
const Intro = () => {
  return (
    ...
    <div className='p-4 bg-blue-400 absolute lg:w-3/4 lg:top-[640px] transform scale-100 hover:scale-50 transition-transform duration-300 ease-in-out rounded-b-lg rounded-t-lg sm:bottom-24'> 
