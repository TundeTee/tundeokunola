...
const ServicesPage = () => {
  return (
     <section className='relative'>
            <img src={servicesImg} alt="law-firm" className='w-full h-[400px] md:h-[600px] lg:h-[750px] object-cover'/>

    <div className="container mx-auto flex flex-col gap-8 text-center p-10 mb-5">
    ...
    <button className='bg-blue-300 px-4 rounded-md hover:underline  '><a href="/pricing">Book</a></button>
    </div>
